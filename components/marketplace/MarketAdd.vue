<template>
  <v-dialog v-model="isOpen" width="1000" persistent>
    <v-card class="pa-10">
      ...
      <div>
        <v-text-field outlined v-model="marketplace.name"></v-text-field>
      </div>
      ...
      <div>
        <v-text-field outlined v-model="marketplace.price"></v-text-field>
      </div>
      ...
      <v-card-actions>
        <v-row align="center">
          ...
          <v-col>
            <v-btn color="success" text @click="addMarketplace" :loading="buttonLoad"> Save </v-btn>
          </v-col>
        </v-row>
      </v-card-actions>
    </v-card>
