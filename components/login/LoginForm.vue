          ...
          .then((response) => {
            ...
            const users = this.$axios
              ...
              .then((users) => {
                ...
                if(users.data.account_type=='Board of Directors' || users.data.account_type=='Community Personnel' || users.data.account_type=='System Admin' ) window.location.href = "/home";
